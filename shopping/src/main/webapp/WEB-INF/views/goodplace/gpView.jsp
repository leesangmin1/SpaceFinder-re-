...
<body>
	...
	<section class="hero-wrap hero-wrap-2"
		style="background-image: url('/resources/publishing-company-master/images/gpView.jpg');"
				...
				<div class="col-md-9 ftco-animate mb-0 text-center">
					<p class="breadcrumbs mb-0">
						<span class="mr-2"><a href="/" style="color: white;">SpaceFinder
							...
							style="color: white;">주차장 보기<i class="fa fa-chevron-right"></i></a></span>
		...
		<div class="container">
			...
			<div class="center-block">
				...
				<p>
					...
					영업시간 : ${gpView.GP_Runtime }<br>정기 휴일 : ${gpView.GP_restday }<br>
